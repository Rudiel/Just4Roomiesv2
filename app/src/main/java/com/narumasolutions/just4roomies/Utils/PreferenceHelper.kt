...
object PreferenceHelper {
    ...
    fun customPref(context: Context, name: String): SharedPreferences = context.getSharedPreferences(name, Context.MODE_PRIVATE)
    ...
    operator fun SharedPreferences.set(key: String, value: Any?) {
        when (value) {
            ...
            else -> throw UnsupportedOperationException("No yet implemented")
        }
    }
